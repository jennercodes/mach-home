...
const OrderCard = ({ order }: OrderCardProps) => {
  ...
  return (
    <div className="bg-white flex flex-col" data-testid="order-card">
      ...
      <div className="flex items-center divide-x divide-line text-small-regular text-ui-fg-base">
      ...
      <div className="grid grid-cols-2 small:grid-cols-4 gap-4 my-4">
        {order.items?.slice(0, 3).map((i) => {
          return (
            ...
            >
              <Thumbnail thumbnail={i.thumbnail} images={[]} size="full" className="!rounded-none !p-0 !shadow-none !aspect-[4/5] !bg-cream" />
